...
const Footer = () => {
    return ( 
        <footer className="bg-dark overflow-hidden  py-10 flex-wrap z-10 flex justify-center p-2 ">
          ...
          <div className="flex-1 flex relative w-full text-sm font-light max-w-5xl justify-between">
            <img src={decoration} className='absolute -z-10 h-[150%] brightness-125 -left-20 -top-10 ' alt="" />
            <div className="text-white flex flex-col gap-1">
                <h6 className='text-lg pb-2 font-medium text-white'>Company info</h6>
                <a href="">about us</a>
                <a href="">careers</a>
            ...
            <div className="text-white flex flex-col gap-1">
            <h6 className='text-lg  pb-2 font-medium text-white'>Costumer Service</h6>
                <a href="">contact us</a>
            ...
            <div className="text-white flex flex-col gap-1">
            <h6 className='text-lg pb-2 font-medium text-white'>Policies</h6>
